...
const AboutFooter = () => {
  ...
  return (
    <section className='w-full bg-gradient-to-l from-bSdenim to-dark text-bSlight px-7'>
        <div >
        <div className='flex justify-center items-center pt-9 pb-14'>
        ...
        <div className='grid grid-cols-3 gap-[10rem] justify-center-center  nike-container xl:grid-cols-1 xl:w-auto  sm:items-start '>
          <div >
            <h2 className='font-serif font-normal text-[25px] pb-1 pl-5 border-l-[3px] border-bSorange w-[99px] sm:w-[100px] rounded-sm tracking-wider'>Suivre</h2>
            <p className='pt-9 sm:w-[200px]'>Rejoignez-nous sur les réseaux sociaux pour rester informé(e) de toutes nos actualités et partager ensemble cette passion qui nous anime ! Suivez-nous pour ne rien manquer .</p>
          ...
          <div className='pt-9 sm:w-[300px]'>
            <ul>
              ...
              <li onClick={()=> navigate('/conditions')} className='py-1 cursor-pointer'>Aide : 
