  ...
  return (
   <>
      <div className='relative h-auto w-auto flex flex-col rounded-3xl  bg-inherit '>
        <div className='bg-theme rounded-t-3xl clip-path h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 left-0 right-0 opacity-100 z-10 '></div>
        <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container'>
          ...
          <div className='flex items-center bg-black rounded-[100%]'>
            <img
              src={img}
              alt='hero-img/img'
              className='  rounded-lg w-30 h-30 lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] transitions-theme -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill'
            />
          </div>
        </div>
      </div>
